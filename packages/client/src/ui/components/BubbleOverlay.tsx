 ...
 * keeping the HTML in sync with the PixiJS canvas without triggering Solid re-renders.
 *
...
export function BubbleOverlay(props: BubbleOverlayProps) {
  ...
  onMount(() => {
    const manager = new BubbleManager(containerRef, props.camera, props.getAvatars);
